...
class Post(models.Model):
    ...
    def whatsapp_share_url(self):
        url = "https://wa.me/?text=http%3A//virtual-obituary.com"+self.get_absolute_url()
        return url

    def facebook_share_url(self):
        url = "https://www.facebook.com/sharer/sharer.php?u=http%3A//virtual-obituary.com"+self.get_absolute_url()
        return url

    def twitter_share_url(self):
        url = "https://twitter.com/intent/tweet?text=http%3A//virtual-obituary.com"+self.get_absolute_url()
        return url
